...
class RequestAssignment(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    request_id = db.Column(db.Integer, nullable=False, unique=True)  # ADDED UNIQUE
...
# Available Requests - FIXED TO SHOW UNASSIGNED REQUESTS
...
def get_available_requests():
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            # Get assigned request IDs from this service
...
# Dealer's Accepted Requests - FIXED
    ...
    for assignment in assignments:
        try:
            ...
            if res.status_code == 200:
                ...
                req_data["user_id"] = assignment.user_id  # ADDED
...
def accept_request():
    ...
    try:
        ...
        # Update request status in user service with dealer_id
...
def complete_request():
    ...
    transaction = Transaction(
        request_id=request_id,
        user_id=assignment.user_id,  # Use from assignment
        dealer_id=user["id"],
